                ...
                if (task.isSuccessful()) {
                    for (QueryDocumentSnapshot document : task.getResult()) {
                        ...
                        if (fotoUrl != "") {
                            ...
                            Picasso.get().load(R.drawable.ic_baseline_contacts_24).fit().into(FotoContact);
                        }
                    }
                } else {
                    Toast.makeText(com.ivan.myapplication.ActivityDetailContact.this, "Error getting documents",
        ...
        if (filePath != null) {
            ...
            Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(com.ivan.myapplication.ActivityDetailContact.this, "Data berhasil disimpan",
                            Toast.LENGTH_SHORT).show();
                    finish();
                }
            });
            ...
            uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(com.ivan.myapplication.ActivityDetailContact.this, "Failed " + e.getMessage(),
