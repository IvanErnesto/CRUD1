...
public class ActivityTambahContact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acticity_tambah_contact);
        ...
        if (filePath != null) {
            ...
            Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(com.ivan.myapplication.ActivityTambahContact.this, "Data berhasil disimpan",
            ...
            uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(com.ivan.myapplication.ActivityTambahContact.this, "Failed " + e.getMessage(),
